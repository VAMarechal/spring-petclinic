...
//                sh 'cp -r lib build'
        ...
        stage('Create Artifact'){
            steps {
                ...
                sh "docker tag spring_petclinic:${BUILD_NUMBER} 18.191.142.161:8080/spring_petclinic:${BUILD_NUMBER}"    
                sh "docker push 18.191.142.161:8080/spring_petclinic:${BUILD_NUMBER}"
            }
        }
        stage('Deploy'){
            steps {
